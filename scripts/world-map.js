...
marker2.bindPopup("<b>China</b> <br>[insert fact]")
marker3.bindPopup("<b>Pakistan</b> <br>[insert fact]")
marker4.bindPopup("<b>Thailand</b> <br>[insert fact]")
marker5.bindPopup("<b>Philippines</b> <br>[insert fact]")
